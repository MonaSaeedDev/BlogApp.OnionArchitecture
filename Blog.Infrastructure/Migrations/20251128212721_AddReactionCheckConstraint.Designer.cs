...
namespace Blog.Infrastructure.Migrations
{
    ...
    [Migration("20251128212721_AddReactionCheckConstraint")]
    partial class AddReactionCheckConstraint
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Blog.Domain.Entities.Reaction", b =>
                {
                    ...
                    b.ToTable("Reactions", null, t =>
                        {
                            t.HasCheckConstraint("CK_Reaction_HasTarget", "[PostId] IS NOT NULL OR [CommentId] IS NOT NULL");
                        });
                });
